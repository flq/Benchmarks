...
public class HashSetVsRegex
{
    ...
    {
        using var file =
            File.OpenRead("/Users/frankquednau/Documents/repos/ahead/Ahead.Web/wwwroot/emojis/emojis-en.json");
...
public class HashSetValidator
{
    ...
    {
        return allowedEmojis?.Contains(emoji) ?? throw new InvalidOperationException("Emoji set not initialized");
    }
}
...
public static class RegexEmojiValidator
{
    ...
    {
        var stringInfo = new StringInfo(potentialEmoji);
